...
class Community
{
    ...
    {
        $article = QueryBuilder::connection()->table('website_news')->select('website_news.*')->select('website_news_categories.category')->setFetchMode(PDO::FETCH_CLASS, get_called_class())
