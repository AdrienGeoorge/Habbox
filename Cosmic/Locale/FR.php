...
$GLOBALS['language'] = array (
    'website' => array (
        ...
        'base' => array(
            ...
            'build_tool'            => 'Outil de construction',
            'build_height'          => 'Hauteur',
            ...
            'panel_jobs'            => 'Recrutements',

            'panel_faq'             => 'Foire aux questions',
            'panel_tickets'         => 'Mes tickets',

            'panel_ranking_wealth'  => 'Richesse',
            'panel_ranking_games'   => 'Jeux',

            'panel_settings'        => 'Mes préférences',
            'panel_password'        => 'Mot de passe',
            'panel_verification'    => 'Authentification sécurisée',
            'panel_mail'            => 'Adresse mail',
            'panel_username'        => 'Changer de pseudo',
            'panel_history'         => 'Mes achats',

            'panel_shop'            => 'Achat de diamants',
            'panel_vip'             => 'VIP Club',
            'panel_badge'           => 'Création de badges',
        ),
        ...
        'javascript' => array(
            ...
            'web_page_profile_login'                        => 'Tu dois être connecté pour aimer!',
            ...
            'web_page_shop_offers_neosurf_description'      => 'Paye facilement avec Neosurf pour acheter des diamants, tu seras ensuite automatiquement crédité de diamants selon le montant que tu auras choisi.',
        ...
        'forum' => array (
            ...
            'topic_closed'              => 'Attention ! Ce sujet est clos, vous n\'êtes pas d\'accord ? Alors contactez-nous via le',
            'topic_helptool'            => 'support',
            'topic_and'                 => 'et',
        ...
        'index' => array (
            ...
            'hook'                    => 'Rejoins notre communauté et créer ton propre avatar, fais-toi des amis, discute, créer tes propres apparts et participe à nos animations!',
            'register'                => 'S\'inscrire',
            'login'                   => 'Se connecter'
        ),
        'home' => array (
            ...
            'event'                   => 'Un evènement est en cours sur Habbox',
        ),
        'lost' => array (
        ...
        'settings_namechange' => array (
            'warning'         => 'Attention! Déconnectez-vous de l\'hôtel avant tout changement de pseudo!',
        ...
        'settings_preferences' => array (
            ...
            'follow_label'        => 'Je ne veux pas être suivi sur ' . Config::site['shortname'],
            ...
            'language_title'      => 'Choix de la langue'
        ),
        ...
        'shop_club' => array (
            ...
            'content_2'           => 'N\'hésite pas à contacter le service client via le ',
        ...
        'shop_history' => array (
            ...
            'draw_tool'           => 'Outils de dessin',
            'add_color'           => 'Ajouter une couleur',
            'draw_reset'          => 'Remettre à zéro',
            'buy_badge'           => 'Acheter mon badge',
            'buy_on'              => 'Acheté le',
            'erase'               => 'Shift + Click pour effacer'
        ),
        'shop_offers' => array (
            'back'              => 'Retour',
        ...
        'shop' => array (
            ...
            'get'               => 'Vous gagnez',
            'shop_success'      => 'Vos diamants ont été ajoutés à votre compte. Si quelque chose ne va pas, veuillez nous contacter via notre centre d\'aide',
            'shop_error'        => 'Une erreur est survenue et l\'achat a été annulé. Vous n\'arrivez pas effectuer votre achat ? Veuillez nous contacter via notre centre d\'aide.',
            'help'              => 'Centre d\'aide',
            'back'              => 'Retour',
    ...
    'core' => array (
        ...
        'notification' => array (
            ...
            'profile_notfound'      => 'Malheureusement... nous n\'avons pas pu trouver le ' . Config::site['shortname'] . '!',
    ...
    'login' => array (
        ...
        'invalid_pincode'           => 'Ce code PIN ne correspond pas aux données précédentes.',
        'fill_in_pincode'           => 'Entre ton code PIN pour accéder à ton compte !'
    ),
    'register' => array (
        'username_invalid'          =>  'Ce pseudo ne respecte pas le format des règles.',
        'username_exists'           =>  'Ce pseudo est déjà utilisé :-(',
    ...
    'settings' => array (
        ...
        'name_change_saved'         => 'Ton pseudo a bien été modifié, 5 diamants viennent d\'être débités de ton compte. Tu dois désormais te reconnecter!',
        'invalid_secretcode'        => 'L\'Authentification Google via code SECRET est incorrecte.',
        'enabled_secretcode'        => 'Méthode d\'authentification définie! Vous devez vous reconnecter... à bientôt!',
