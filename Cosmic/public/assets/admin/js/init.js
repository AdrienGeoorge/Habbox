                            ...
                            var output = '\
                                    <div class="kt-user-card-v2">\
                                        <div class="kt-user-card-v2__pic">\
                                            <div class="kt-badge kt-badge--xl"><span class="kt-portlet__head-icon"><img src="' + Site.figure_url + '/avatarimage?figure=' + data.look + '&headonly=1&head_direction=3&gesture=&size=s" alt="image"></span></div>\
                                        </div>\
